...
import { deleteVideo, addVideoView, toggleVideoPublish,getSubscriptionVideos, uploadVideo, getAllVideos,getVideo } from "../controllers/video.controller.js";
...
router.route("/video/:_id").post(getVideo);
